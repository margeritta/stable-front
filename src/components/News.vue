<template>
  <div>
    <v-container>
      <p class="display-3 font-weight-light text-center pa-4">Aktualności</p>
...
export default {
  ...
  computed: {
    ...
    gettersusers() {
      return this.$store.getters.allNewses;
    },
    isLoggedIn() {
